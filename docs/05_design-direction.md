...
| 表情バリエーション | 5種（通常 / 嬉しい / 悲しい / 不安 / 元気） |

### 感情連動の仕様

| 感情状態 | アバター変化 |
|----------|-------------|
| 自由っぽい（猫） | 耳が猫耳に / ゆったりした動き |
| 寂しい（ウサギ） | 耳が垂れる / 色味が青寄りに |
| 元気（ライオン） | たてがみ出現 / 跳ねるアニメーション |
| 穏やか（クマ） | ぽっちゃり化 / ゆっくり揺れる |
| 好奇心（キツネ） | 尻尾出現 / キョロキョロ動く |

### MVP 実装方針

- Phase 1: 静的SVGアバター 1種（表情固定）
- Phase 2: 感情に応じた表情差し替え（5種の静的SVG切り替え）
...
| 🐰 ウサギ | ふわふわ、繊細 | `#89CFF0`（Ocean Mist） |
| 🦁 ライオン | 堂々、力強い | `#FFD700`（Sunset Gold） |
| 🐻 クマ | まるっこい、安心 | `#8B7355`（Warm Brown） |
| 🦊 キツネ | シャープ、知的 | `#FF8C42`（Fox Orange） |
